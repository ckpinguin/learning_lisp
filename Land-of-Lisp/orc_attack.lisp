...
(defun orc-battle ()
  ...
  (when (monsters-dead)
    (princ "Congratulations! You have prevailed!")))
...
; Generic stuff for monsters
(defstruct monster (health (randval 10)))

; defmethod allows overwriting of functions
...
(defmethod monster-attack ((m slime-mold))
  (let ((x (randval (slime-mold-sliminess m))))
    ...
    ;a one in two chance to get some slime in the face
    (when (zerop (random 2))
      (princ "It also sqirts in your face, taking away a health point! ")
      (decf *player-health*))))
